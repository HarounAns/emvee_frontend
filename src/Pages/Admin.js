...
export default function Admin() {
  ...
  const createTeam = async (data) => {
    await axios.post(`${EMVEE_API_URL}/teams`, data);
    await axios.post(`${EMVEE_API_URL}/sets`, { pokepasteURL });
  };
  ...
  return (
    <Container>
      {createSuccessful && (
        <p style={{ color: "green" }}>Successfully Created Team</p>
      )}
      <Form className="form" onSubmit={handleSubmit}>
        ...
        {pokepasteData && (
          <>
            ...
            {invalidTeam && (
              <p style={{ color: "red" }}>Must Fill Out Entire Form</p>
            )}
